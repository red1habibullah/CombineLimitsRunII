...
XRANGE = [2.5,30]
UPSILONRANGE = [8,11]
subdirectoryName='KinFit_mumu_AUG19_RooDataSet_AddControlBin_x' + str(XRANGE[0]) + 'to' + str(XRANGE[1]) + '/'
...
def GetPPSignal(dictionary,xRange=[],yRange=[], rooDataSet=False):
  ...
  for hMass in HMASSES:
     for aMass in AMASSES:
       ...
       h_Central    = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_Central_Plots")
       h_IDDOWN     = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_IDDOWN_Plots")
       h_IDUP       = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_IDUP_Plots")
       h_IsoDOWN    = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_IsoDOWN_Plots")
       h_IsoUP      = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_IsoUP_Plots")
       h_BTagDOWN   = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_BTagDOWN_Plots")
       h_BTagUP     = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_BTagUP_Plots")
       h_PileupDOWN = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_PileupDOWN_Plots")
       h_PileupUP   = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_AUG19_PileupUP_Plots")
...
def GetFPData(dictionary,xRange=[],yRange=[], rooDataSet=False):
   ...
   f_FakeRateRegionB = ROOT.TFile.Open("/eos/cms/store/user/ktos/ShapeDifferences/FINAL_RooDataSet_MiniAOD_SingleMu_MedIsoMu2_TauDMAntiMedIso_AUG19_BItself_Plots.root")
   if rooDataSet:
...
def GetFPSignal(dictionary,xRange=[],yRange=[], rooDataSet=False):
  ...
  for hMass in HMASSES:
     for aMass in AMASSES:
       if (str(hMass) == "300" or str(hMass) == "750") and (str(aMass) == "3p6" or str(aMass) == "4" or str(aMass) == "6"): continue
       h_Central    = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_Central_Plots")
       h_IDDOWN     = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_IDDOWN_Plots")
       h_IDUP       = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_IDUP_Plots")
       h_IsoDOWN    = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_IsoDOWN_Plots")
       h_IsoUP      = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_IsoUP_Plots")
       h_BTagDOWN   = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_BTagDOWN_Plots")
       h_BTagUP     = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_BTagUP_Plots")
       h_PileupDOWN = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_PileupDOWN_Plots")
       h_PileupUP   = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_AUG19_PileupUP_Plots")
...
LimitsClass = HaaLimits(dictionary, tag='KinFit_mumu_AUG19_RooDataSet_AddControlBin_x' + str(XRANGE[0]) + 'to' + str(XRANGE[1]))
