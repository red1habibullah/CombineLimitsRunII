...
HMASSES = [125,300,750]
subdirectoryName='mumufourBody_SEP5_PPyDG_FPyDCB/'
...
#       h_BTagDOWN   = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_SEP2_BTagDOWN_Plots_fourBody")
#       h_BTagUP     = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMMedIso_SEP2_BTagUP_Plots_fourBody")
...
#       h_BTagDOWN   = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_SEP2_BTagDOWN_Plots_fourBody")
#       h_BTagUP     = f.Get("SIG_h" + str(hMass) + "a" + str(aMass) + "_MedIsoMu2_TauDMAntiMedIso_SEP2_BTagUP_Plots_fourBody")
...
LimitsClass = HaaLimits2D(dictionary, tag='mumufourBody_SEP5_PPyDG_FPyDCB')
...
LimitsClass.addSignalModels(fit=False, yFitFuncFP="DCB", yFitFuncPP="DG",  isKinFit=False)
LimitsClass.XRANGE = XRANGE
