...
# TauETauHad    
##     python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --unblind --xRange 2.5 8.5 --tag lowmass_${channel}_${year}_MVAMedium_DG_DoubleExpo_Spline_wFakeTauScale_unblind --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log1${year} &
##     python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --unblind --xRange 6 14 --tag upsilon_${channel}_${year}_MVAMedium_DG_DoubleExpo_Spline_wFakeTauScale_unblind --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log2${year} &
##     python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --unblind --xRange 11 25 --tag highmass_${channel}_${year}_MVAMedium_DG_DoubleExpo_Spline_wFakeTauScale_unblind --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log3${year} &
...
# TauMuTauHad
##     python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --unblind --fitParams --xRange 2.5 8.5 --yRange 50 150 --tag lowmass_${channel}_${year}_MVAMedium_DG_DoubleExpo_yRange_wFakeTauScale_unblind --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log1${year} &
##     python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --unblind --fitParams --xRange 6 14 --yRange 50 150 --tag upsilon_${channel}_${year}_MVAMedium_DG_DoubleExpo_yRange_wFakeTauScale_unblind --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log2${year} &
##     python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --unblind --fitParams --xRange 11 25 --yRange 50 150 --tag highmass_${channel}_${year}_MVAMedium_DG_DoubleExpo_yRange_wFakeTauScale_unblind --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log3${year} &

# TauHadTauHad
    python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --fitParams --xRange 2.5 8.5 --yRange 50 150 --tag lowmass_${channel}_${year}_MVAMedium_DG_DoubleExpo_yRange_wFakeTauScaleJEC --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log1${year} &
    python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --fitParams --xRange 6 14 --yRange 50 150 --tag upsilon_${channel}_${year}_MVAMedium_DG_DoubleExpo_yRange_wFakeTauScaleJEC --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log2${year} &
    python haaLimitsDevToolsRunII.py mm h --parametric --addControl --unbinned --fitParams --xRange 11 25 --yRange 50 150 --tag highmass_${channel}_${year}_MVAMedium_DG_DoubleExpo_yRange_wFakeTauScaleJEC --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log3${year} &
